...
<h1 class="centered">Requests For Authorize Users  </h1>
...
Query q = hbm.createSession().createQuery("from User where status=:id");
q.setParameter("id", id);
List list = q.list();
  Iterator itr = q.iterate();
	while(itr.hasNext()) {
	  User s = (User) itr.next();
	  out.println("<div class=\"course\">");
		out.println("<img src=\"avatar.jpg\" alter=\"Course Image\">");
		out.println("<div class=\"course-details\">");
	out.println(" <h5>User ID: "+s.getUid()+" - Name : <strong>"+s.getUname()+"</strong> <br>Email : "+s.getEmail()+"</h5>");
	out.println("</div>");
	out.println("</div>");
  }
  t.commit();
...
<p>
<input type="text" id="username" name="id" placeholder="User ID" required><i class="validation"><span></span><span></span></i>
</p>
