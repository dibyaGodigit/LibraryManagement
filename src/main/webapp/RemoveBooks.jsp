...
<h1 class="centered">Remove Books  </h1>
...
Query q = hbm.createSession().createQuery("from Book where bid=:id");
...
List list = q.list();
  Iterator itr = q.iterate();
	...
	out.println(" <h3>Book ID: "+s.getBid()+" - Name : <strong>"+s.getBname()+"</strong> <br>Cost : "+s.getCost()+"</h3>");
	out.println("</div>");
	out.println("</div>");
  }
  t.commit();
