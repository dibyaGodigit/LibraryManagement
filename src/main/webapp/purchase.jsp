...
List list = q.list();
  Iterator itr = q.iterate();
	...
	out.println(" <h3>Course ID: "+s.getBid()+" - Name : <strong>"+s.getBname()+"</strong> <br>Cost : "+s.getCost()+"/-</h3>");
	out.println("</div>");
	out.println("</div>");
	session.setAttribute("cost", s.getCost());
	session.setAttribute("bname", s.getBname());
  }
  t.commit();
