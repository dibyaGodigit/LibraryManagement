...
<h1 class="centered">Subscriptions  </h1>
...
Query q = hbm.createSession().createQuery("from Subscription");
...
List list = q.list();
  Iterator itr = q.iterate();
	...
	out.println(" <h5>Subscriprion ID: "+s.getSubs_id()+" - Amount : <strong>"+s.getAmount()+"</strong> <br>Invoice : "+s.getInvoice()+"<p>Date :"+s.getDate()+" </p></h5>");
	out.println("</div>");
	out.println("</div>");
  }
  t.commit();
